...
import { getCustomerGoogleAuthUrl, loginCustomer } from "@/lib/customer-auth-api"
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      saveAuthSession(response.metadata)
      router.push("/profile")
    } catch (error) {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      setError(getErrorMessage(error, "Không thể bắt đầu đăng nhập Google"))
    }
  }
